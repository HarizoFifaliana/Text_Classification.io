...
class NgramsLogisticRegression:
    def __init__(self, ngrams_range=(2, 5)):
        """
        Initialise le vectoriseur avec les N-grams de longueur spécifiée.
        """
        self.vectorizer = CountVectorizer(ngram_range=ngrams_range, stop_words="english", max_features=10000)
        self.model = LogisticRegression(max_iter=1000)

    def preprocess(self, texts):
        """
        Transforme les textes en une représentation N-grams.
        """
...
def main():
    ...
    # Initialiser la classe et entraîner le modèle avec des N-grams
    print("Entraînement du modèle avec N-grams (n=2,3,5)...")
    classifier = NgramsLogisticRegression(ngrams_range=(2, 5))
